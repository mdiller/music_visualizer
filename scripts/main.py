...
from process_stems import StemProcesser
...
SPLEETER_DIR = os.path.join(DATA_DIR, "_spleeter")
VIDEOS_DIR = os.path.join(DATA_DIR, "videos")
SONG_DIR = os.path.join(DATA_DIR, "songs", song_name)
...
# STEP 0: initial song processing
song_processor = SongProcessor(song_name)
song_info = song_processor.run()
...
with open(mp3_link_stub_file, "w+") as f:
	f.write(f"import audio from '../../data/songs/{song_name}/song.mp3'\nexport const MP3_FILE = audio;")
